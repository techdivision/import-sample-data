...
--
-- Host: localhost    Database: magento_ce_235
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Adminnotification Inbox';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2332 DEFAULT CHARSET=utf8 COMMENT='Catalog Category Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6164 DEFAULT CHARSET=utf8 COMMENT='Catalog Category Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8 COMMENT='Catalog Category Text Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6680 DEFAULT CHARSET=utf8 COMMENT='Catalog Category Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=134261 DEFAULT CHARSET=utf8 COMMENT='Catalog Product To Category Linkage Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Bundle Option';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Bundle Option Value';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=234 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Bundle Selection';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=268774 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalog_product_entity_datetime` (
  ...
  KEY `CATALOG_PRODUCT_ENTITY_DATETIME_VALUE` (`value`),
...
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Datetime Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `catalog_product_entity_decimal` (
  ...
  KEY `CATALOG_PRODUCT_ENTITY_DECIMAL_VALUE` (`value`),
...
) ENGINE=InnoDB AUTO_INCREMENT=100457 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Decimal Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `catalog_product_entity_int` (
  ...
  KEY `CATALOG_PRODUCT_ENTITY_INT_VALUE` (`value`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1068330 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `catalog_product_entity_media_gallery` (
  ...
  KEY `CATALOG_PRODUCT_ENTITY_MEDIA_GALLERY_VALUE` (`value`),
...
) ENGINE=InnoDB AUTO_INCREMENT=18844 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Media Gallery Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=91137 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Media Gallery Attribute Value Table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_catalog_product_entity_media_gallery_value_after_insert AFTER INSERT ON catalog_product_entity_media_gallery_value FOR EACH ROW
BEGIN
INSERT IGNORE INTO `scconnector_google_feed_cl` (`entity_id`) VALUES (NEW.`entity_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_catalog_product_entity_media_gallery_value_after_update AFTER UPDATE ON catalog_product_entity_media_gallery_value FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_catalog_product_entity_media_gallery_value_after_delete AFTER DELETE ON catalog_product_entity_media_gallery_value FOR EACH ROW
BEGIN
INSERT IGNORE INTO `scconnector_google_feed_cl` (`entity_id`) VALUES (OLD.`entity_id`);
END */;;
DELIMITER ;
...
) ENGINE=InnoDB AUTO_INCREMENT=53396 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Text Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=701537 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8 COMMENT='Catalog Product To Product Linkage Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Link Integer Attribute Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3825 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Super Attribute Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3825 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Super Attribute Label Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=48028 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Super Link Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=238112 DEFAULT CHARSET=utf8 COMMENT='Cataloginventory Stock Item';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2673 DEFAULT CHARSET=utf8 COMMENT='Cron Schedule';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=514 DEFAULT CHARSET=utf8 COMMENT='Eav Attribute';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1328 DEFAULT CHARSET=utf8 COMMENT='Eav Attribute Group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8337 DEFAULT CHARSET=utf8 COMMENT='Eav Attribute Option';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=utf8 COMMENT='Magento Swatches table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `eav_attribute_option_value` (
  ...
  KEY `EAV_ATTRIBUTE_OPTION_VALUE_VALUE` (`value`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8409 DEFAULT CHARSET=utf8 COMMENT='Eav Attribute Option Value';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 COMMENT='Eav Attribute Set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8985 DEFAULT CHARSET=utf8 COMMENT='Eav Entity Attributes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `import_file_upload`
--

DROP TABLE IF EXISTS `import_file_upload`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `import_file_upload` (
  `file_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'file_id',
  `filename` text NOT NULL COMMENT 'filename',
  `entities` varchar(100) NOT NULL COMMENT 'entities',
  `operation` varchar(100) NOT NULL COMMENT 'operation',
  `archive_artefacts` smallint(6) NOT NULL COMMENT 'archive_artefacts',
  `debug_mode` smallint(6) NOT NULL COMMENT 'debug_mode',
  `single_transaction` smallint(6) NOT NULL COMMENT 'single_transaction',
  `log_level` varchar(100) NOT NULL COMMENT 'log_level',
  `status` int(6) NOT NULL COMMENT 'status',
  `import_mode` varchar(100) NOT NULL COMMENT 'import_mode',
  `cache_enabled` varchar(100) NOT NULL COMMENT 'cache_enabled',
  PRIMARY KEY (`file_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='Import File Upload Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1672 DEFAULT CHARSET=utf8 COMMENT='Import history table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=98625 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `pacemaker_order_export`
--

DROP TABLE IF EXISTS `pacemaker_order_export`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pacemaker_order_export` (
  `order_id` int(10) unsigned NOT NULL COMMENT 'Sales Order Entity Id',
  `is_scheduled` smallint(5) unsigned DEFAULT NULL COMMENT 'Scheduled for export flag',
  `is_exported` smallint(5) unsigned DEFAULT NULL COMMENT 'Exported flag for orders',
  `external_id` varchar(255) DEFAULT NULL COMMENT 'External system identifier',
  `scheduled_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Scheduled for export at timestamp',
  `exported_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Exported at timestamp',
  UNIQUE KEY `PACEMAKER_ORDER_EXPORT_ORDER_ID` (`order_id`),
  KEY `PACEMAKER_ORDER_EXPORT_IS_EXPORTED` (`is_exported`),
  KEY `PACEMAKER_ORDER_EXPORT_IS_SCHEDULED` (`is_scheduled`),
  KEY `PACEMAKER_ORDER_EXPORT_EXTERNAL_ID` (`external_id`),
  CONSTRAINT `PACEMAKER_ORDER_EXPORT_ORDER_ID_SALES_ORDER_ENTITY_ID` FOREIGN KEY (`order_id`) REFERENCES `sales_order` (`entity_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Extension attribute values for sales_order entities';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `pacemaker_order_line_item`
--

DROP TABLE IF EXISTS `pacemaker_order_line_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pacemaker_order_line_item` (
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Sales Order Item Id',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Sales Order Entity Id',
  `number` varchar(255) DEFAULT NULL COMMENT 'Uniq value per line item per order',
  UNIQUE KEY `PACEMAKER_ORDER_LINE_ITEM_PARENT_ID` (`parent_id`),
  UNIQUE KEY `PACEMAKER_ORDER_LINE_ITEM_ORDER_ID_NUMBER` (`order_id`,`number`),
  KEY `PACEMAKER_ORDER_LINE_ITEM_NUMBER` (`number`),
  CONSTRAINT `PACEMAKER_ORDER_LINE_ITEM_PARENT_ID_SALES_ORDER_ITEM_ITEM_ID` FOREIGN KEY (`parent_id`) REFERENCES `sales_order_item` (`item_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Extension attribute values for sales_order_item table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 COMMENT='List of data/schema patches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pipeline_entity` (
  `pipeline_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Pipeline ID',
  `name` varchar(64) NOT NULL COMMENT 'Pipeline name',
  ...
  `has_warnings` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT 'Indicates, whether warnings occured during processing of pipeline step.',
  PRIMARY KEY (`pipeline_id`),
  KEY `PIPELINE_ENTITY_STATUS` (`status`),
  KEY `PIPELINE_ENTITY_STARTED_AT` (`started_at`),
  KEY `PIPELINE_ENTITY_FINISHED_AT` (`finished_at`),
  KEY `PIPELINE_ENTITY_EXPIRES_AT` (`expires_at`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Pipeline Entity Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pipeline_step` (
  `step_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Pipeline Step ID',
  `pipeline_id` int(10) unsigned NOT NULL COMMENT 'Foreign ID for pipeline relation',
  `parent_step_id` int(10) unsigned DEFAULT NULL COMMENT 'Foreign ID for parent step',
  `name` varchar(64) NOT NULL COMMENT 'Step name',
  `status` varchar(32) NOT NULL COMMENT 'Status',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `started_at` datetime DEFAULT NULL,
  `finished_at` datetime DEFAULT NULL,
  `log` text COMMENT 'Executor result log',
  `conditions` text COMMENT 'List of conditions (JSON)',
  `recurring_conditions` text COMMENT 'List of conditions for step recurring execution (JSON)',
  `executor_type` varchar(255) DEFAULT '' COMMENT 'Class name for executor',
  `arguments` text COMMENT 'JSON arguments for given step',
  `sort_order` int(10) NOT NULL DEFAULT '0' COMMENT 'sorting order for steps',
  `has_warnings` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT 'Indicates, whether warnings occured during processing of pipeline step.',
  `can_finish` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT 'All pending steps can be skipped, once this step is ready.',
  `run_always` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT 'This argument defines that the step will be run always without preconditions.',
  PRIMARY KEY (`step_id`),
  KEY `PIPELINE_STEP_PIPELINE_ID` (`pipeline_id`),
  KEY `PIPELINE_STEP_PARENT_STEP_ID` (`parent_step_id`),
  KEY `PIPELINE_STEP_NAME` (`name`),
  KEY `PIPELINE_STEP_STATUS` (`status`),
  KEY `PIPELINE_STEP_STARTED_AT` (`started_at`),
  KEY `PIPELINE_STEP_FINISHED_AT` (`finished_at`),
  KEY `PIPELINE_STEP_SORT_ORDER` (`sort_order`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='Pipeline Steps Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3436315 DEFAULT CHARSET=utf8 COMMENT='scconnector_google_feed_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scconnector_google_remove_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2115050 DEFAULT CHARSET=utf8 COMMENT='scconnector_google_remove_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `techdivision_index_suspended`
--

DROP TABLE IF EXISTS `techdivision_index_suspended`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `techdivision_index_suspended` (
  `index_suspender_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Index Suspender ID',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `externalkey` varchar(100) DEFAULT NULL COMMENT 'Key or ID for external use (eg. Pipelines)',
  PRIMARY KEY (`index_suspender_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='All active suspenders.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `techdivision_index_trigger_suspensions`
--

DROP TABLE IF EXISTS `techdivision_index_trigger_suspensions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `techdivision_index_trigger_suspensions` (
  `suspend_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Suspend Id',
  `index_code` varchar(255) NOT NULL COMMENT 'Name of suspended index',
  `process_key` varchar(255) NOT NULL COMMENT 'Identifier for process',
  PRIMARY KEY (`suspend_id`),
  KEY `TECHDIVISION_INDEX_TRIGGER_SUSPENSIONS_INDEX_CODE` (`index_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Management for automated indexer trigger switcher';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `url_rewrite` (
  ...
  KEY `URL_REWRITE_ENTITY_ID_ENTITY_TYPE` (`entity_id`,`entity_type`)
) ENGINE=InnoDB AUTO_INCREMENT=31783 DEFAULT CHARSET=utf8 COMMENT='Url Rewrites';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Weee Tax';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-07-15 23:09:09
